...
- [parallel local search](https://docs.rs/rapid_solve/heuristics/parallel_local_search/index.html)
...
- [tabu search](https://docs.rs/rapid_solve/heuristics/tabu_search/index.html) (and a faster [parallel
  version](https://docs.rs/rapid_solve/heuristics/parallel_tabu_search/index.html))
